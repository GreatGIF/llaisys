...
void rearrange(tensor_t out, tensor_t in) {
    ...
    case LLAISYS_DEVICE_NVIDIA:
        return nvidia::rearrange(out->data(), in->data(), out->dtype(), out->shape(), out->strides(), in->strides(), in->ndim());
#endif
#ifdef ENABLE_MX_API
    case LLAISYS_DEVICE_MX:
        return mx::rearrange(out->data(), in->data(), out->dtype(), out->shape(), out->strides(), in->strides(), in->ndim());
#endif
    default:

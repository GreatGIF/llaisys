...
void rms_norm(tensor_t out, tensor_t in, tensor_t weight, float eps) {
    ...
    case LLAISYS_DEVICE_NVIDIA:
        return nvidia::rms_norm(out->data(), in->data(), weight->data(), out->dtype(), m, n, eps);
#endif
#ifdef ENABLE_MX_API
    case LLAISYS_DEVICE_MX:
        return mx::rms_norm(out->data(), in->data(), weight->data(), out->dtype(), m, n, eps);
#endif
    default:
